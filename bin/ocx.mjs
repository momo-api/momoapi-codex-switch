 ...
 * `npm install -g @momo-api/momoapi-codex-switch` work without a separately-installed Bun,
...
function runNpmSelfUpdate() {
  ...
  console.log(`momoapi-codex-switch v${current} (installed via npm, tag ${tag})`);
