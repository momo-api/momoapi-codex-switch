...
export function providerConfigSeed(entry: ProviderRegistryEntry): OcxProviderConfig {
  ...
  return {
    ...
    ...(entry.googleApiKeyTransport !== undefined ? { googleApiKeyTransport: entry.googleApiKeyTransport } : {}),
    ...
    ...(entry.directGeminiWireRenames !== undefined ? { directGeminiWireRenames: entry.directGeminiWireRenames } : {}),
