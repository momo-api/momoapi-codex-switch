...
export interface ProviderRegistryEntry {
  ...
  googleApiKeyTransport?: OcxProviderConfig["googleApiKeyTransport"];
...
export const PROVIDER_REGISTRY: readonly ProviderRegistryEntry[] = [
  ...
  },
  {
    ...
    apiKeyTransport: "bearer", dashboardUrl: "https://momoapi.us/console/user", defaultModel: "claude-opus-4-6-thinking", liveModels: false,
    models: ["claude-opus-4-6-thinking"],
    note: "MOMO native Anthropic Messages models.",
  },
  {
    id: "momo-gemini", label: "MOMO API (Gemini)", adapter: "google", baseUrl: "https://momoapi.us", authKind: "key",
    googleApiKeyTransport: "bearer", directGeminiWireRenames: false, dashboardUrl: "https://momoapi.us/console/user", defaultModel: "gemini-3.7-flash", liveModels: false,
