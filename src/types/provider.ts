...
export interface OcxProviderConfig {
  ...
  */
  ...
  /**
   * Google-compatible gateway key header style. Native Gemini uses
   * `x-goog-api-key`; MOMO's Gemini gateway uses `Authorization: Bearer`.
   */
  googleApiKeyTransport?: "x-goog-api-key" | "bearer";
