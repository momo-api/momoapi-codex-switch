...
```
ClientID         configured via GOOGLE_ANTIGRAVITY_CLIENT_ID
ClientSecret     configured via GOOGLE_ANTIGRAVITY_CLIENT_SECRET
CallbackPort     51121
...
> Configure these OAuth client credentials through
